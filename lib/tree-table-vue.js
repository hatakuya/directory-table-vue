...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_iview_src_components_radio__ = __webpack_require__(65);
  ...
  methods: {
    ...
    handleEvent: function handleEvent($event, type, data, others) {
      ...
      if ((certainType.row || certainType.checkbox) && others.clickRow) {
        ...
        var checkStatus = !row._isChecked;
            ...
            [_this2.table.tableColumns.map(function (column, columnIndex) {
              return h(
                'td',
                {
                  ...
                  on: {
                    'click': function click($event) {
                      return _this2.handleEvent($event, 'cell', { row: row, rowIndex: rowIndex, column: column, columnIndex: columnIndex }, { clickRow: false });
                    },
                    'dblclick': function dblclick($event) {
                      return _this2.handleEvent($event, 'cell', { row: row, rowIndex: rowIndex, column: column, columnIndex: columnIndex }, { clickRow: false });
                    },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  render: function render() {
    ...
    function renderLabel(column, columnIndex) {
      ...
      if (this.isSelectionCell(this.table, columnIndex) && this.table.selectType === 'checkbox') {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__radio_group_vue__ = __webpack_require__(68);
...
var update = __webpack_require__(22)("7a2a2f68", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(22)("d0dc2c1e", content, true);
